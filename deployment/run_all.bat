...
start "SAT-SA Backend" cmd /c "python -m uvicorn backend.app.main:app --host 127.0.0.1 --port 8000"
timeout /t 3 /nobreak >nul

start "SAT-SA Frontend" cmd /c "cd frontend && npm run dev -- --host 127.0.0.1 --port 5173"
